  ...
  return (
    <>
      ...
      <div className="bg-white border-b border-gray-200 hidden md:block">
        <div className="max-w-6xl mx-auto px-6 py-2 flex items-center justify-between text-xs text-navy-700/60 font-sans">
      ...
      >
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <Link href="/" className="flex flex-col">
            <span className="font-serif text-xl font-bold text-navy-900 tracking-tight leading-none">
              Camden
            </span>
          ...
          <div className="hidden md:flex items-center gap-8">
            {links.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="text-sm font-sans text-navy-700/75 hover:text-navy-900 transition-colors tracking-wide"
              >
                {link.label}
              </Link>
            ))}
            <a
              ...
              className="text-sm font-sans text-navy-700/75 hover:text-navy-900 transition-colors tracking-wide flex items-center gap-1.5"
            >
              <svg
            ...
            <div className="flex flex-col gap-4 pt-4">
              {links.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="text-navy-700 hover:text-navy-950 transition-colors font-sans"
              ...
              <a
                href={BUSINESS.phoneHref}
                className="text-navy-700 hover:text-navy-950 transition-colors font-sans flex items-center gap-2"
              >
